...
public class ManagerService {
    ...
    public ManagerSaveResponse saveManager(AuthUser authUser, long todoId, ManagerSaveRequest managerSaveRequest) {
        ...
        try {
            ...
            // 성공 로그 기록
            logService.saveLog(user.getId(), managerSaveRequest.getManagerUserId(), todoId, "SUCCESS");
            ...
            // 실패 로그 기록
            logService.saveLog(user.getId(), managerSaveRequest.getManagerUserId(), todoId, "FAIL: " + e.getMessage());
